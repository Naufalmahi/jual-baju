...
<body>
    <div class="error-page">
        <div class="error-card fade-in">
            ...
            <div class="error-code" style="color:var(--warning)">408</div>
            <h2>Waktu Habis</h2>
            <p>Permintaan kamu memakan waktu terlalu lama. Silakan coba lagi dengan koneksi yang lebih stabil.</p>
