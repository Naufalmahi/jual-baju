...
<body>
    <div class="error-page">
        <div class="error-card fade-in">
            ...
            <div class="error-code" style="color:var(--danger)">500</div>
            <h2>Terjadi Kesalahan Server</h2>
            <p>Maaf, sistem kami mengalami gangguan sementara. Tim kami sedang berusaha memperbaikinya. Silakan coba lagi dalam beberapa saat.</p>
